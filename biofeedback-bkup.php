...
<head>
    ...
    <meta name="description" content="My graduation project, a digital game that uses the player's biofeedback to change the gameplay.">
        ...
        <div id="biofeedback">
            <section>
                ...
                <article class="artigo">
                    ...
                    <p>It's about a chicken (a space chicken, to be more precise). Our hero's (the chicken) planet have been infected with a symbiotic parasite (very creative, I know), that spread it to every thing in the planet, living or not, and that it's all one big organism. Except you, the chicken, and now you have to escape, but in order to escape you have to make your way out through vicious monsters and deadly traps.</p>
                    ...
                    <p><strong>REYNOLDS, E..</strong> Quit Playing Games with My Heart: Biofeedback in Gaming. <i>Available at: <a href="http://www.gamasutra.com/blogs/ErinReynolds/20131029/203265/Quit_Playing_Games_with_My_Heart_Biofeedback_in_Gaming.php" target="_blank" class="external-link">gamasutra.com</a></i>, Last access: September, 2015.</p>
                    </article>
