...
$(document).ready(function() {
	...
	$('#svBox').prepend('<div class="container">\<div class="svPlayer">\
	<div class="infoBox">\
	<div class="nowPlaying"><h3 class="svTitle svTitleFix highlight">Here it is, a bunch of videos that I made.</h3></div>\
	</div>\
	</div>\
    </div>');
...
$(document).ready(function(){
    $('.svThumb').click(function() {
        ...
        window.location="#vid-anchor";

		$('.closeUiBtn').remove();
		$('#svBox').prepend('<div class="container">\<div class="closeUiBtn">&times;</div>\</div>');
        return false;
    });
	// Fechar Videos
